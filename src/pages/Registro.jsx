...
export default function Registro() {
  ...
  const emailInvitado = searchParams.get("email") ?? ""
  ...
  function handleSubmit(e) {
    ...
    if (!valido) return
    const yaRegistrado = usuarios.some(u => u.email === emailInvitado && u.estado === "activo")
    if (yaRegistrado) { setEnlaceUsado(true); return }
    setExito(true)
  }
