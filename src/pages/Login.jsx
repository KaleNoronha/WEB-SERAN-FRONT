...
export default function Login() {
  ...
  function handleSubmit(e) {
    ...
    if (!email) { mostrarError("Credenciales incompletas"); return }
    if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) { mostrarError("Ingrese un correo válido"); return }
    if (!password) { mostrarError("Credenciales incompletas"); return }
    ...
    setErrorVisible(false)
    login(usuario)
    if (usuario.rol === "admin") navigate("/admin/usuarios")
    else navigate("/doctor/pacientes/nuevo")
  }
