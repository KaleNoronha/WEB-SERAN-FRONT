...
function RutaProtegida({ children }) {
  ...
  if (cargando) {
    return <div className="min-h-screen flex items-center justify-center text-xs text-slate-400">
      Cargando sesión...
    </div>
  }
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/registro-doctor/:token" element={<Registro />} />
      ...
      <Route path="/admin/recomendaciones" element={<RutaAdmin><ConfigRecomendaciones /></RutaAdmin>} />
